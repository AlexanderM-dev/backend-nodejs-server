...
import { addProduct, changeProduct, deleteProduct, getProductList } from '../controllers/product.controller';
...
productRouter.get('/', tokenCheck, appAdminCheck, getProductList);
